<div class="slider-container rev_slider_wrapper" style="height: 650px;">
    <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 650, 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': false }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
        <ul style="padding:0px;">
            <li data-transition="fade" class="slide-overlay slide-overlay-level-0 containers" >
                
            <img src="<?=IMAGES_URL?>banner-0-1.jpg"  
            alt=""
                ...
                <div class="container py-1">
                    <div class="row align-items-center " style="margin-top:9rem;">
                        <div class="col-lg-6 mb-5">
                            ...
                            <p class="text-6 text-capitalize appear-animation text-color-light" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900" data-appear-animation-duration="750">Our trusted Project and Programme management partner</p>
